    ...
    <form action="{{Route('updaterole')}}" method="post">
        ...
        <div class="container mt-4 card p-3 w-50 border border-dark ">
            <div class="form-group required ">
                ...
                <input type="text" class="form-control border border-dark" name="role" id="role" value="{{$role->role_name}}">
            ...
            <div class="form-group required ">
                ...
                <input type="text" class="form-control border border-dark" name="slug" id="slug" value="{{$role->slug}}">
                <span class="text-danger">
                    @error('slug')
                    {{$message}}
                    @enderror
