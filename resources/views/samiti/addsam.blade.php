...
<div class="container my-4 text-black border-white body ">
    ...
    <h1 class="text-center ">Add New Samiti</h1>

    <form action="{{Route('storesam')}}" method="post">
        @csrf
        ...
        <div class="container mt-4 card p-3 w-50 border border-dark ">
            ...
            <div>
                <div class="form-group required ">
                    ...
                    <input type="text" class="form-control border border-dark" name="samiti" id="samiti" value="{{old('samiti')}}">
                    <span class="text-danger">
                        @error('tehsil')
                        {{$message}}
                        @enderror
                ...
                <div>
                    ...
                    <div>
                        <button class="btn btn btn-primary btn-sm" type="submit" href="/allsamiti">Add</button>
                    </div>
                </div>
            </div>
    </form>
