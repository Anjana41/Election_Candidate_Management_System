    ...
    <form action="{{Route('updatestate')}}" method="post">
        ...
        <div class="container mt-4 card p-3 w-50 border border-dark ">
            <div class="form-group required ">
                ...
                <input type="text" class="form-control border border-dark" name="newstate" id="newstate" value="{{$states->name}}">
            ...
            <div class="form-group required ">
                ...
                <input type="text" class="form-control border border-dark" name="slug" id="slug" value="{{$states->slug}}">
                <span class="text-danger">
                    @error('slug')
                    {{$message}}
                    @enderror
